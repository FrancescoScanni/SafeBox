...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
  ...
  <div class="flex items-center gap-3">
    <div class="relative">
      ...
      <input type="text" name="q" placeholder="Search vault..." class="w-full sm:w-64 bg-white/5 border border-white/10 rounded-full pl-10 pr-4 py-2.5 text-sm placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-teal-400/50 focus:border-teal-400/50">
    </div>
